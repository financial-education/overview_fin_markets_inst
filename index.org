...
#+Caption: Change in the number of banks
[[./dygraph_banks.png]]

*Programming Exercise*: Use the ~/summary~ call [[https://banks.data.fdic.gov/docs/#/operations/Historical/getHistorical][from the BankFind API here]] to find the total number of FDIC institutions by quarter.
